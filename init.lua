...
-- My Custom Keymaps
vim.keymap.set({ 'n', 'x' }, '<C-B>', ':NvimTreeToggle<CR>')
vim.keymap.set({ 'n', 'x' }, '<C-Tab>', ':BufferLineCycleNext<CR>')
vim.keymap.set({ 'n', 'x' }, '<C-M-I>', ':CopilotChatToggle<CR>')
vim.keymap.set({ 'n', 'x' }, '<C-J>', ':bo sp +terminal<CR>')
...
local on_attach = function(client, bufnr)
  ...
  -- nmap('<leader>rp', '<cmd>Lspsaga rename ++project<cr>', '[R]ename [P]roject')
...
--  ['<leader>h'] = { name = 'More git/Harpoon', _ = 'which_key_ignore' },
...
vim.g.terminal_color_1 = "#b21818"
vim.g.terminal_color_2 = "#18b218"
vim.g.terminal_color_3 = "#ffd500"
vim.g.terminal_color_4 = "#1140e7"
vim.g.terminal_color_5 = "#b218b2"
vim.g.terminal_color_6 = "#18b2b2"
vim.g.terminal_color_7 = "#b2b2b2"
vim.g.terminal_color_8 = "#686868"
vim.g.terminal_color_9 = "#ff5454"
vim.g.terminal_color_10 = "#54ff54"
vim.g.terminal_color_11 = "#ffff54"
vim.g.terminal_color_12 = "#5454ff"
vim.g.terminal_color_13 = "#ff54ff"
vim.g.terminal_color_14 = "#54ffff"
